...
class WordsAdapter(private val listWords: ArrayList<String>) : RecyclerView.Adapter<WordsAdapter.ViewHolder>() {
    ...
    class ViewHolder(private val binding: ItemWordsBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = ItemWordsBinding.inflate(LayoutInflater.from(parent.context), parent, false)
